...
/**
 * Per-model capability icons, ported from 9router's CapacityBadges + CAPACITY_META.
 * Caps are DERIVED from the model id (not stored per-model) via the same resolver
 * 9router uses, so badges match wherever the model appears. Only set caps render.
 */
